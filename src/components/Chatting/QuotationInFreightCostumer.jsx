...
//   console.log(location.state.data.freight_client_id);
//   const activeChat =
//     location.state?.data || JSON.parse(localStorage.getItem("activeChat"));
//   const RECEIVER_ID = activeChat?.id || activeChat?.freight_client_id;
...
//     console.log(LOGGED_IN_USER_ID, RECEIVER_ID);
//     try {
