...
//       if (desc.includes("pick") || desc.includes("up") || desc.includes("fee")) {
...
//       } else if (desc.includes("forward") || desc.includes("foreward")) {
...
//   const [freight, setFreight] = useState(mapEstimateComponentsToFlatFields(location?.state?.data) || [0]);
