                        ...
                        <td style={{ padding: 0 }}>
                          <div style={{ width: "100%", display: "flex" }}>
                            ...
                            >
                              ...
                              >
                                {new Date(data?.actual_delivery_date).toLocaleDateString("en-GB") == "01/01/1970" ? "" : new Date(data?.actual_delivery_date).toLocaleDateString("en-GB")}
                              </p>
                            </div>
                            <div
                              style={{
